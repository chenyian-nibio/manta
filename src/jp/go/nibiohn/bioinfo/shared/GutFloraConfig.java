...
public class GutFloraConfig {

	public static final String PGSQL_PROP_FILE= "gutflora.db.properties";
	
	public static final String TABLE_HEADER_FILE= "table.header.properties";
