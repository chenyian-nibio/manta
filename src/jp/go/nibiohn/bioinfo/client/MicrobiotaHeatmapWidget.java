...
public class MicrobiotaHeatmapWidget extends ReadVisualizeWidget {
	...
	public MicrobiotaHeatmapWidget(Set<SampleEntry> selectedSamples, String rank, Integer experimentMethod,
			boolean isSubset, String lang) {
		this("Heat Map", GutFloraConstant.NAVI_LINK_VIEW_HEATMAP, selectedSamples, rank, experimentMethod, isSubset, lang);
	}

	public MicrobiotaHeatmapWidget(String expTag, Set<SampleEntry> selectedSamples, String rank, Integer experimentMethod,
			boolean isSubset, String lang) {
		this("Heat Map (" + expTag + ")", GutFloraConstant.NAVI_LINK_VIEW_HEATMAP, selectedSamples, rank, experimentMethod, isSubset, lang);
	}
