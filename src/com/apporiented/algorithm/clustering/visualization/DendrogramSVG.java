...
/**
 * A copy of DendrogramPanel, but replace Graphics2D with SVGGraphics2D. (modified by chenyian)
 *
 */
public class DendrogramSVG {
    ...
    public SVGGraphics2D drawDendrogram(int width, int height) {
        SVGGraphics2D g2 = new SVGGraphics2D(width, height);
        g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
        g2.setColor(lineColor);
        g2.setStroke(SOLID_STROKE);

        int wDisplay = width - borderLeft - borderRight;
        int hDisplay = height - borderTop - borderBottom;
